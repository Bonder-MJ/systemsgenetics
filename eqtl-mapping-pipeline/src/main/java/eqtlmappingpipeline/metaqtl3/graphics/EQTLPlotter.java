...
public class EQTLPlotter {
    ...
    private final int outputPlotsFileType = FILE_TYPE_PDF;
...
//        fileName = m_outputDir + "" + logPValueString + "-" + snpName + "-" + probeName + ".pdf";
    ...
    public void drawBinary(WorkPackage wp, int pid) {
        System.setProperty("java.awt.headless", "true");
        ...
        String fileName = m_outputDir + "" + logPValueString + "-" + snpName.replace("/", "_") + "-" + probeName.replace("/", "_").replace(";", "_") + "_bin.pdf";
//        fileName = m_outputDir + "" + logPValueString + "-" + snpName + "-" + probeName + ".pdf";
        File file = new File(fileName);
