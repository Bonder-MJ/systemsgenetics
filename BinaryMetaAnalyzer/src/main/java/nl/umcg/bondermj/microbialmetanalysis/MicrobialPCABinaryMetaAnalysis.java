 ...
 * @author Harm-Jan
 */
public class MicrobialPCABinaryMetaAnalysis {
    ...
    public static void main(String[] args) {
        ...
        MicrobialPCABinaryMetaAnalysis meta = new MicrobialPCABinaryMetaAnalysis(settingsFile, textToReplace, replaceTextWith);
        System.exit(0);
    ...
    public MicrobialPCABinaryMetaAnalysis(String settingsFile, String textToReplace, String replaceTextWith) {
        // initialize settings
        ...
        try {
            ...
            Logger.getLogger(MicrobialPCABinaryMetaAnalysis.class.getName()).log(Level.SEVERE, null, ex);
        }
