...
public class BinaryMicrobiomMetaAnalysisDataset {
    ...
    public BinaryMicrobiomMetaAnalysisDataset(String dir, String prefix, int permutation, String platform, MetaQTL4TraitAnnotation probeAnnotation) throws IOException {
    ...
    private void loadSNPs(String snpFile) throws IOException {
        ...
        snpProbeMap = new MetaQTL4MetaTrait[nrSNPs][0];
...
//        tf.open();
    ...
    public MetaQTL4MetaTrait[] getProbes(int snp) {
        return snpProbeMap[snp];
    }
